...
f'   pio_sm_put_blocking(pio, sm, {(CLKFREQ*1000000//b - 4) // d0}); // floor((b - w) / d0) = floor(({CLKFREQ*1000000//b} - 4)/{d0}) ', 
f'   pio_sm_put_blocking(pio, sm, {(CLKFREQ*1000000//b - 4) // d1}); // floor((b - w) / d1) = floor(({CLKFREQ*1000000//b} - 4)/{d1}) ', 
 '}', '', '', 
